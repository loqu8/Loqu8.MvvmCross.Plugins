...
{
    public interface IMvxCompressionStreamFactory
    {
        // Summary:
        ...
        IMvxCompressionStream Create(Stream stream, CompressionLevel compressionLevel);
        ...
        IMvxCompressionStream Create(Stream stream, CompressionMode mode);
        ...
        //     The stream does not support write operations such as compression. (The System.IO.Stream.CanWrite
        //     property on the stream object is false.)
        IMvxCompressionStream Create(Stream stream, CompressionLevel compressionLevel, bool leaveOpen);
        ...
        //     is false.-or-System.IO.Compression.CompressionMode is System.IO.Compression.CompressionMode.Decompress
        //     and System.IO.Stream.CanRead is false.
        IMvxCompressionStream Create(Stream stream, CompressionMode mode, bool leaveOpen);
    }
}